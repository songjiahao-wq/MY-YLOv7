...
3.alpha参数为AlphaIoU中的alpha参数，默认为1,1的意思就是跟正常的IoU一样，如果想采用AlphaIoU的话，论文alpha默认值为3。
4.跟Focal_EIoU一样，我认为AlphaIoU的思想同样可以用在其他的IoU变种上，简单来说就是如果你设置了alpha为3，其他IoU设定的参数(GIoU，DIoU，CIoU，EIoU，SIoU)为False的时候，那就是AlphaIoU，如果你设置了alpha为3，CIoU为True的时候，那就是AlphaCIoU，
