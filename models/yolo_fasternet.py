...
from models.fasternet.fasternet import *
import timm
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../cfg/training/yolov7_fasternet.yaml', help='model.yaml')
